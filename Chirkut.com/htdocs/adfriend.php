...
<div id="wrap">
	...
	<div id="content">
		<div id="page">
		<h3>Add someone in your group !</h3><br><br>
<?php
...
$query = "select user_info.Name,pending_list.friendName from pending_list,user_info where pending_list.friendName=user_info.userName and pending_list.username='$flistf'"; 
...
{
echo "<li><b>Accept ! : </b><a href='/acc.php?rmfd=$myrow[1]'>$myrow[0]</a> </li>"; 
echo "<li><b>Deny ! : </b><a href='/deny.php?rmfd=$myrow[1]'>$myrow[0]</a> </li>"; 
}
...
<div id="wrap">
	...
	<div id="nav">
		<ul>
			<li><a href="/profile.php">Profile</a></li>
			<li><a href="/scrap.php">Scrap Book</a></li>
			<li><a href="/album.php">Album</a></li>
			<li><a href="/search.php">Search</a></li>
			<li><a href="/adfriend.php">Add Friend`s</a></li>
			<li><a href="/rmfriend.php">Remove Friend`s</a></li>
...
$query = "select user_info.Name,pending_list.friendName from friend_list,user_info where pending_list.friendName=user_info.userName and pending_list.username='$flistf'"; 
$result = mysql_query($query) or die(mysql_error());
